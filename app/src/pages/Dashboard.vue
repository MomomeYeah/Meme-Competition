    ...
    <div>
        <v-container class="py-8">
            ...
            <v-row v-if="competitionsStore.userOwnedCompetitions.length > 0">
                ...
                <v-col
                    v-for="comp in competitionsStore.userOwnedCompetitions"
                    :key="comp.id"
                    cols="12"
                    md="6"
                    lg="4"
            ...
            <v-row v-if="competitionsStore.userJoinedCompetitions.length > 0">
                ...
                <v-col
                    v-for="comp in competitionsStore.userJoinedCompetitions"
                    :key="comp.id"
                    cols="12"
                    md="6"
                    lg="4"
            ...
            <v-row
                v-if="
                    competitionsStore.userOwnedCompetitions.length === 0 &&
                    competitionsStore.userJoinedCompetitions.length === 0
                "
            >
                <v-col cols="12">
                    <v-alert type="info">
                        ...
                        or browse available competitions.
                    </v-alert>
                </v-col>
            </v-row>
